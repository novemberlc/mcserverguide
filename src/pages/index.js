            ...
            <main>
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '75vh' }}>
                    <div style={{ textAlign: 'center', maxWidth: '500px', width: '80%' }}>
                        ...
                        <p3>Have something to contribute? <b><Link to="https://github.com/novemberlc/mcserverguide">Please do!</Link></b> We want to enable people to learn, and sharing knowledge is the best way to do that.</p3>
