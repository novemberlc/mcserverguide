...
This guide is incomplete. If you know what you're doing, please only use this guide for reference in this state.
...
To secure the backend, we'll use WireGuard, a free, fast, and open source VPN service.
